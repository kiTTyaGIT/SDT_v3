...
void print_message()
{
	...
	cout << " <count.txt> - файл, содержащий найденные члены рифмующихся пар и количество появлений каждого из слов;" << endl;
	cout << "\nПримечание: В текстовом файле <rhyme.txt> в квадратных скобках справа от найденного члена пары записываются номера предложений, в которых он встречается; " << endl;
