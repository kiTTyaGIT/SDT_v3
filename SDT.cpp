...
void print_message()
{
	cout << "Здвравствуйте! Вы начали работу с программой для формирования рифмованных пар глаголовРифмованные пары из поступающего текста записаны в файл: <rhyme.txt>" << endl
