...
void count_words()  //вывод числа появлений каждого из слов
{
	...
	if (fout.is_open())
	{
		fout << "Данный текстовый файл содержит найденные члены рифмующихся пар и количество появлений каждого из слов.\n\n" << endl;
...
void print_message()
{
	...
	cout << " <text.txt> - входной файл на русском;" << endl;
	cout << " <numbered_text.txt> - файл, содержащий упорядоченные предложения входного файла;" << endl;
	cout << " <rhyme.txt> - файл, содержащий найденные рифмованные пары." << endl;
	cout << " <count.txt> - файл, содержащий найденные члены рифмующихся пар и количество появлений каждого из слов;" << endl << endl;
	...
	cout << "\nОбратите внимание, что при повторном запуске программы существующие текстовые файлы будут перезаписаны! " << endl << endl;
